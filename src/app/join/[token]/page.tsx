...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  ...
  expired: {
    ...
    body: 'Este convite expirou. Peça ao administrador da conta que envie um novo link.',
  },
  server_error: {
    title: 'Algo deu errado',
    body: 'Não foi possível verificar este convite agora. Atualize a página daqui a pouco.',
  },
};
  ...
  const inviteHeader = (
    <CardHeader className="items-center text-center">
      ...
      <CardTitle className="text-xl text-foreground">
        Você recebeu um convite para entrar em{' '}
          ...
          <DialogContent className="bg-popover border-border sm:max-w-md">
            ...
            <div className="space-y-2 py-2 text-xs text-muted-foreground">
              <p>
                ...
                O link do convite permanecerá válido enquanto não expirar.
              </p>
            </div>
