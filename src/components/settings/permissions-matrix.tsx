...
const MODULE_LABELS: Record<Module, string> = {
  ...
  'custom-reports': 'Relatório Personalizado',
    ...
    <div className="space-y-6">
      <header className="space-y-2">
        ...
        <p className="text-muted-foreground max-w-2xl text-sm">
          O que cada perfil pode abrir. A regra é a mesma para todas as empresas
          — o perfil é definido por empresa, então a mesma pessoa pode ser
          Gerente em uma e Vendedor em outra.
        </p>
      </header>
      ...
      <div className="text-muted-foreground space-y-3 text-sm">
        <p>
          <strong className="text-foreground">Vendedor</strong> atende:
          conversas, contatos, pipeline e painel.
        </p>
        <p>
          <strong className="text-foreground">Gerente</strong> acrescenta o que
          é irreversível — transmissões, que não podem ser canceladas depois de
          enviadas, e a aprovação de conversões, que libera investimento em
          anúncio.
        </p>
        <p>
          <strong className="text-foreground">Administrador</strong> acrescenta
          o que muda o sistema para todo mundo: integrações, IA, automações e
          chaves.
        </p>
        <p className="border-t pt-3">
          <strong className="text-foreground">Sobre os dados:</strong> qualquer
          perfil enxerga todos os contatos e negócios da empresa em que está. Os
          perfis controlam o que a pessoa pode <em>fazer</em>, não quais
