...
export interface Contact {
  ...
  company?: string;
  avatar_url?: string;
  /** Platform that originated the lead: a Meta click-to-WhatsApp ad
   *  (Facebook / Instagram) or a Google Ads click. Null = organic. */
  acquisition_source?: 'Facebook' | 'Instagram' | 'Google' | null;
...
export interface WhatsAppConfig {
  id: string;
  user_id: string;
  /** Nullable for provider='uazapi' rows — UAZAPI has no Meta phone_number_id. */
  phone_number_id: string | null;
  waba_id?: string;
  /** Nullable for provider='uazapi' rows — they use uazapi_token instead. */
  ...
  /** Which WhatsApp backend this row uses. Defaults to 'meta' (migration 036-046). */
